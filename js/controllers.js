  ...
  .controller('languageSpecificListings', ['$scope', '$routeParams', function($scope, $routeParams){
    ...
    if(lang === 'c'){
      ...
      $scope.resources = [
        ...
        $scope.lang = 'cpp';
        $scope.specificLanguage = 'C++';
        $scope.languageSrc = 'images/logos/cpp-logo.jpeg';
        ...
        $scope.lang = 'html5';
        $scope.languageSrc = 'images/logos/html5-logo.png';
        ...
        $scope.languageSrc = 'images/logos/dot-net.png';
        ...
        $scope.lang = 'git';
        $scope.languageSrc = 'images/logos/git-logo.png';
        ...
        $scope.lang = 'php';
        $scope.languageSrc = 'images/logos/php-logo.png';
        $scope.imageArray = {
        ...
        $scope.lang = 'ruby';
        $scope.languageSrc = 'images/logos/ruby-logo.png';
        ...
        $scope.lang = 'python';
        $scope.languageSrc = 'images/logos/python-logo.jpg';
        ...
        $scope.lang = 'java';
        $scope.languageSrc = 'images/logos/java-logo.png';
        ...
        $scope.specificLanguage = 'C#';
        $scope.lang = 'cSharp';
        $scope.languageSrc = 'images/logos/cSharp-logo.png';
        ...
        $scope.languageSrc = 'images/logos/objective-c-logo.png';
        ...
        $scope.lang = 'perl';
        $scope.languageSrc = 'images/logos/perl-logo.JPG';
